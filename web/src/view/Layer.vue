<template>
    <div class="layer-global">
            ...
            <header class="layer-header">
                <div class="header-left">
                        ...
                        <svg class="svg-logo" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            viewBox="0 0 160 36" enable-background="new 0 0 160 36" xml:space="preserve">  <image
                    ...
                    <div class="app-cpy">
                        <p>
                            ©️ {{ new Date().getFullYear() }} <a href="https://github.com/zoom-ci/zoom-ci/"
                                                                 target="_blank">Zoom</a>. All Rights Reserved. MIT
                            License.
                        </p>
                    </div>
                </div>
        ...
        <el-dialog :width="$root.DialogSmallWidth" title="个人设置" :visible.sync="settingDialogVisible"

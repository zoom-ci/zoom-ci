...
func (install *Install) Install() error {
	...
	zoom.App.DB = server.NewDatabase(&server.DbConfig{
		...
		TablePrefix:     zoom.App.Config.Db.TablePrefix,
	...
	zoom.App.DB.DbHandler.Exec("INSERT INTO `zoom_user_role` (`id`, `name`, `privilege`, `ctime`) VALUES(1, '管理员', '2001,2002,2003,2004,2100,2101,2102,2201,2202,2203,2204,2205,2206,2207,3001,3002,3004,3003,3101,3102,3103,3104,4001,4002,4003,4004,4101,4102,4103,4104,1001,1002,1006,1003,1004,1005', 0);")
